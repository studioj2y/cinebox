...
def reply_for(question, opt_text, tags):
    ...
    if "小动物" in q or "动物" in q:
        ...
        if "鹰" in t: return "想飞就飞，随你。"
        if "树懒" in t: return "躺平，天经地义。"
    ...
    # ---- 2) 标签基调兜底（稍微人性化润色，松弛但不敷衍）----
    tone = {
        "治愈": "行，就慢慢暖过来。", "温暖": "暖一下，刚刚好。", "温情": "温柔的，我记下了。",
        "热血": "那就燃起来，没毛病。", "爽": "爽就完事了，别想太多。", "轻松": "轻松点看，最舒服。", "喜剧": "笑出来就行，图个乐。",
        "致郁": "懂的，丧的时候也挺真。", "孤独": "一个人待着，也挺好。", "暗黑": "冷一点，反而带感。", "冷峻": "冷着，才清醒。",
        "悬疑": "烧脑的，陪你一起想。", "烧脑": "脑子动起来，才过瘾。", "浪漫": "甜的，这就给你安排上。", "爱情": "恋爱脑这就上线了。", "和伴侣": "俩人看，最甜。",
        "慢节奏": "不急，咱慢慢品。", "快节奏": "快点，才够过瘾。", "冒险": "那就浪起来。", "旅行": "出发，看好路上的风景。",
        "社会": "清醒着看，也挺好。", "写实": "真实的东西，最戳心。", "战争": "厚重的，来吧。", "历史": "老故事，越嚼越有味。",
        "音乐": "跟着律动一起看。", "美食": "看饿了，是真馋。", "职场": "打工人，太懂了。", "青春": "那股少年气，真上头。", "成长": "成长ing，慢慢来。",
        "家庭": "家的味道，最暖。", "恐怖": "凉一下，够刺激。", "奇幻": "去做个梦吧。", "童话": "做个梦也好。", "动画": "动画，一样香。",
        "明亮": "亮堂堂的，舒服。", "荒诞": "荒诞的，乐就完事。", "震撼": "震撼一下，值了。", "经典老片": "老片，经得起看。", "新片": "新鲜货，尝尝。",
        "和朋友": "拉上朋友，才热闹。", "一个人看": "一个人看，自在。", "通勤": "路上看，打发时间。", "深夜": "深夜场，刚好对味。", "周末": "周末窝着，最爽。",
        "惊悚": "凉一下，够刺激。",
    }
    for tag in tags:
        if tag in tone:
